  ...
  return (
    <div className="max-w-4xl mx-auto pb-4">
      <div className="mb-4">
        ...
        <p className="text-st-textSecondary text-sm">Offer your expertise or request someone else's.</p>
      </div>

      <div className="glass-card rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden h-fit">
        {/* Decorative background glow */}
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-st-accent/15 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
            ...
            <div className="lg:col-span-2 space-y-3">
              <div>
                <label className="block text-st-textSecondary text-[10px] font-bold mb-1.5 uppercase tracking-wider ml-1">
                ...
                <div className="relative">
                  ...
                  />
                  <Tag size={15} className="absolute inset-y-0 left-3.5 my-auto text-st-accent" />
                </div>
              </div>

              <div>
                <label className="flex items-center gap-2 text-st-textSecondary text-sm font-bold mb-3">
                  <Briefcase size={18} className="text-st-accent" /> Description
                </label>
                <textarea 
                  name="description"
              ...
              {formData.type === 'TEACH' && (
                <div>
                  <label className="flex items-center gap-2 text-st-textSecondary text-sm font-bold mb-3">
                    <ExternalLink size={18} className="text-st-accent" /> Portfolio / Reference
                  </label>
                  <input 
                    type="url" 
                    name="portfolioLink"
            ...
            <div className="space-y-3">
              <div className="bg-st-bgSecondary/50 border border-st-card/80 rounded-2xl p-4 shadow-inner">
                <h3 className="text-white font-bold mb-3 border-b border-st-card/50 pb-2 text-sm">Exchange Format</h3>
                
                <div className="space-y-3">
                  <div>
                    <label className="flex items-center gap-2 text-st-textSecondary text-sm font-bold mb-3">
                    <GraduationCap size={18} className="text-st-accent" /> Payment Method
                  </label>
                    <select 
                      name="method"
                    ...
                    >
                      <option value="BARTER" className="bg-st-bgSecondary text-white">Barter Skills (No credits)</option>
                      <option value="CREDITS" className="bg-st-bgSecondary text-white">Use Credits (1 Cr/hr)</option>
                      <option value="BOTH" className="bg-st-bgSecondary text-white">Accept Both (1 Cr/hr or Barter)</option>
                    </select>
                  </div>

                  {(formData.method === 'BARTER' || formData.method === 'BOTH') && (
                    <div>
                      <label className="block text-st-textSecondary text-[10px] font-bold mb-1.5 uppercase tracking-widest">
                  ...
                  {(formData.method === 'CREDITS' || formData.method === 'BOTH') && (
                    <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                      <p className="text-[10px] font-bold text-st-accent uppercase tracking-widest mb-1">Platform Rate</p>
              ...
              <div className="md:col-span-2">
                <label className="flex items-center gap-2 text-st-textSecondary text-sm font-bold mb-3">
                  <Clock size={18} className="text-st-accent" /> Availability / Schedule
                </label>
                <div className="relative">
                  <input 
                    type="text" 
          ...
          <div className="pt-4 flex justify-end border-t border-st-card border-dashed">
            <button 
              type="submit" 
              disabled={saving} 
